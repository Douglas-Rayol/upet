<?php 
        ...
        if($_SERVER['REQUEST_METHOD'] == "POST"){        
            ...
            $id = $_POST["id"];
            $sql = "UPDATE administrador SET nome = ?, telefone = ?, endereco = ?  WHERE idadministrador = ?";
            $stmt = mysqli_prepare($link, $sql);
    ...
    <body>
    <h2>Alteração de Administrador</h2>
    <form method="post" action="update.php">
        ...
        <input type="hidden" name="id" value="<?php echo $row['idadministrador'] ?>">
